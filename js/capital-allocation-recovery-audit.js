// Phase 8D-11: deterministic, read-only audit of resilience recovery progress.
...
modules.capitalAllocationRecoveryAudit=Object.freeze({wholeCash,auditFromPlan,audit,renderKey,render,enhance,installUI,__installed:true});
installUI();
})(0);
