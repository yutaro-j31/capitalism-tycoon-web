...
// 全国チェーンの規模の経済: 2店舗目以降、他の自社コンビニ1店につき仕入原価を1%改善し、
// 最大14%で頭打ちにする。単店には効果を与えず、PB原価改善とは乗算で合成する。
const CHAIN_UNIT_COST_DISCOUNT_PER_STORE=.01,CHAIN_UNIT_COST_DISCOUNT_MAX=.14;
