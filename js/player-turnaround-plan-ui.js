...
function standalone(html){return `<section class="card player-turnaround-standalone" data-player-turnaround-standalone="1" aria-live="polite"><div class="card-head"><div><h2>再建計画</h2><p>危機状態が解除された後も、危機対応パネルと分離して進行中の財務目標を継続表示します。</p></div><span class="badge good">継続中</span></div><div class="card-body">${html}</div></section>`;}
