...
// T26-0: push で積む配列の上限（末尾＝最新を残す）。出どころは js/engine.js の LOG_ARRAY_TAIL_CAPS。
function tailCap(key){return globalThis.__capitalismTycoonModules?.engine?.LOG_ARRAY_TAIL_CAPS?.[key]??200;}
