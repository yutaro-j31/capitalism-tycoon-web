...
class TycoonEngine extends EventTarget {
  ...
  advanceWeek(showSummary=true) {
    ...
    if(!this.g.skipWeeklyValidation){finance.validate(this.g);supply.validate(this.g);}
