...
const baseAdvance=Engine.prototype.advanceWeek;Engine.prototype.advanceWeek=function(){const before=Math.floor(n(this.g?.week,0)),result=baseAdvance.apply(this,arguments),after=Math.floor(n(this.g?.week,0));if(after<=before)return result;processWeek(this);this.save?.();return result;};
