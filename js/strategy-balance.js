...
const baseNormalize=EngineClass.prototype.normalize;if(typeof baseNormalize!=='function')throw new Error('engine normalize API is missing.');
EngineClass.prototype.normalize=function(){const result=baseNormalize.call(this);apply(this.g);return result;};
const baseConfigure=EngineClass.prototype.configure;if(typeof baseConfigure!=='function')throw new Error('engine configure API is missing.');
EngineClass.prototype.configure=function(options={}){return this.runTransaction(()=>{const result=baseConfigure.call(this,options);apply(this.g);return result;});};
