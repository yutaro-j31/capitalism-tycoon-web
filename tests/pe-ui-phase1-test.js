...
assert.deepEqual(adapter.getPEUIData(),{unlocked:false,active:false,navigation:adapter.NAVIGATION,dashboard:null,deals:[],bid:null,portfolio:null},'missing state must use safe defaults');
