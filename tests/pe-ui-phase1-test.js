...
globalThis.__capitalismTycoonModules={peFund:pf,maDealRoom:ma,playerEngineBridge:{getEngine:()=>state?{g:state}:null},dUIShell:{money:v=>`${v}円`},uiEnhancerRegistry:{registerUIEnhancer(){}}};
