...
assert.deepEqual(Object.keys(data.dashboard).sort(),['capital','dealCount','decisions','diligence','formation','fund','fundComparison','investmentPeriod','performance','slots'].sort());
