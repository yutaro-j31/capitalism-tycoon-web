...
assert.deepEqual(adapter.getPEUIData(),{unlocked:false,navigation:adapter.NAVIGATION,dashboard:null,deals:[],bid:null,portfolio:null},'missing state must use safe defaults');
