...
assert.equal(game.advanceMADealRound(deal.id), true, 'PE mode T3: screening -> indication round advance must succeed');
...
assert.equal(game.advanceMADealRound(deal.id), true, 'PE mode T3: ready -> final_bid round advance must succeed');
