...
const midQuarter=publicGame(load.modules);midQuarter.g.week=15;midQuarter.g.finance.transactions.push({week:13,category:'productDevelopment',amount:9_000_000,description:'前四半期投資'},{week:14,category:'productDevelopment',amount:1_000_000,description:'当四半期投資'});const rollingMetrics=midQuarter.capitalAllocationMetrics(),quarterMetrics=midQuarter.capitalAllocationMetrics('quarter');
