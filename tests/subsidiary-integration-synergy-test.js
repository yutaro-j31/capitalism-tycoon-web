...
assert.equal(preview.cost,25_000_000);assert.equal(preview.valuationAfter,140_000_000);assert.equal(preview.weeklyProfitAfter,2_160_000);
...
console.log('Subsidiary integration synergy accounting, cooldown, determinism and UI tests passed');