...
const expected = [
  ...
  './js/player-crisis-ui.js','./js/app.js','./js/player-crisis.js','./js/player-crisis-actions.js','./js/player-crisis-restructuring.js','./js/player-debt-service.js'
];
...
assert(expected.at(-2) === './js/player-crisis-restructuring.js', 'restructuring must precede debt service');
assert(expected.at(-1) === './js/player-debt-service.js', 'debt service must be the final player crisis extension');
...
const requiredExports = {
  ...
  playerDebtService:['baseRate','weeklyRate','weeklyInterest','inWeeklyContext','__installed']
};
...
for (const marker of ['__competitorMediaInstalled','__competitorParityCompatibilityInstalled','__playerCrisisInstalled','__playerCrisisActionsInstalled','__playerCrisisRestructuringInstalled','__playerDebtServiceInstalled']) assert(modules.engine.TycoonEngine.prototype[marker] === true, `${marker} missing`);
...
assert(typeof modules.engine.TycoonEngine.prototype.companyWeeklyBorrowRate === 'function', 'weekly borrow rate hook missing');
assert(typeof modules.engine.TycoonEngine.prototype.companyWeeklyInterest === 'function', 'weekly interest helper missing');
...
expectThrow(() => run(freshWith(prefix('./js/player-crisis-actions.js')), './js/player-debt-service.js'), /player-crisis-restructuring\.js/);
...
for (const src of [
  ...
  './js/player-crisis-ui.js','./js/player-crisis.js','./js/player-crisis-actions.js','./js/player-crisis-restructuring.js','./js/player-debt-service.js','./js/competitor-terminal-compat.js','./js/competitor-distress.js','./js/data.js'
