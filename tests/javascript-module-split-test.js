...
assert(expected.at(-15) === './js/player-crisis-ui.js', 'player-crisis-ui.js must precede the engine bridge');
assert(expected.at(-14) === './js/player-engine-bridge.js', 'engine bridge must capture the app load');
assert(expected.at(-13) === './js/strategy-balance.js', 'strategy balance must precede progression balance');
assert(expected.at(-12) === './js/progression-balance.js', 'progression balance must precede app startup');
assert(expected.at(-11) === './js/app.js', 'app.js must compose the engine before post-app balance modules');
assert(expected.at(-10) === './js/difficulty-scenario-balance.js', 'difficulty scenario balance must precede crisis lifecycle');
