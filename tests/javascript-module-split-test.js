...
for (const [name, keys] of Object.entries({
  ...
  market:['TARGET_BUSINESS_IDS','SEGMENTS','calculateStoreMarket','validateResult'],
...
const missingMarket = createBrowserContext();
vm.runInContext(scripts[0].code, missingMarket);vm.runInContext(scripts[1].code, missingMarket);
assert.throws(() => vm.runInContext(scripts[3].code, missingMarket), /market module/);
