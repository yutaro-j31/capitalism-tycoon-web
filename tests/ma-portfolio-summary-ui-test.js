...
assert(exitHTML.includes('候補詳細を表示（2社）'),'collapsed details reports evaluated count');
...
assert(bounded.includes('候補詳細を表示（10社）'),'bounded card reports all evaluated candidates');
assert(bounded.includes('ほか2社は優先順位順に省略表示しています'),'bounded card reports omitted rows');
assert(bounded.indexOf('data-ma-exit-row')>bounded.indexOf('data-ma-exit-details'),'bounded full rows remain collapsed');
