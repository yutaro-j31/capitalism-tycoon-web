...
assert.ok(unqualified.length<=36,`Stage 3-4 observer ceiling regressed: expected at most 36 unqualified observer-driven JS files, got ${unqualified.length}`);
assert.ok(comprehensive.length<=37,`Stage 3-4 observer ceiling regressed: expected at most 37 comprehensive observer-driven JS files, got ${comprehensive.length}`);
