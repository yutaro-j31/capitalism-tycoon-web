...
has(play,'./js/play-runtime-compat.js','play launcher must load runtime compatibility before enhancements');
has(play,'./js/iphone-playtest-fixes.js','play launcher must load remediation JS');
assert(play.indexOf('./js/play-runtime-compat.js')<play.indexOf('./js/iphone-playtest-fixes.js'),'runtime compatibility must load before iPhone enhancements');
