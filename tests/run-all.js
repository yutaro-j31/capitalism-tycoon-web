...
const commands = [
  ...
  'test:player-crisis','test:player-crisis-actions','test:player-crisis-turnaround-fund','test:player-crisis-ui','test:player-crisis-restructuring','test:player-crisis-restructuring-ui','test:player-debt-service','test:player-turnaround-plan',
  'test:load','test:week','test:transaction','test:long','test:css','test:javascript','test:modules','test:stock',
  'test:market','test:microcap','test:player-media-advertising','test:market-migration','test:market-ui','test:market-capacity','test:market-cannibalization','test:market-calibration','test:market-order','test:market-opening','test:market-rng',
...
const nodeTests = [
  ...
  ['map-phase2-iphone-scroll-filter-legend', 'tests/map-phase2-iphone-scroll-filter-legend-test.js'],
  ['map-phase2-tenant-detail-mobile', 'tests/map-phase2-tenant-detail-mobile-test.js'],
  ['iphone-toast-bottom-nav-clearance', 'tests/iphone-toast-bottom-nav-clearance-test.js'],
  ...
  ['investor-offer', 'tests/investor-offer-test.js'],
  ['store-zero-investment-founding', 'tests/store-zero-investment-founding-test.js'],
  ...
  ['map-directory-open-state-persistence', 'tests/map-directory-open-state-persistence-test.js'],
  ...
  ['product-operating-kernel', 'tests/product-operating-kernel-test.js'],
  ...
  ['pe-fund-gp-commit-ui', 'tests/pe-fund-gp-commit-ui-test.js'],
  ...
  ['pe-conveni-bridge-208week-regression', 'tests/pe-conveni-bridge-208week-regression-test.js'],
  ['pe-conveni-bridge-negative', 'tests/pe-conveni-bridge-negative-test.js'],
  ...
  ['pe-full-playloop', 'tests/pe-full-playloop-test.js'],
