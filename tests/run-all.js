...
const commands = [
  ...
  'test:digital-product-economics','test:product-innovation','test:ceo-dashboard','test:ma-acquisition-financing','test:weekly-impact','test:founding-tutorial','test:ma-deal-room','test:ma-integration','test:ma-portfolio-summary','test:ma-portfolio-summary-ui','test:ma-board-approval','test:startup-funding-round','test:personal-real-estate'
