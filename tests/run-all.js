...
const commands = [
  ...
  'test:product-innovation','test:ceo-dashboard','test:weekly-impact','test:founding-tutorial','test:ma-deal-room','test:ma-integration','test:ma-portfolio-summary','test:ma-portfolio-summary-ui','test:ma-board-approval'
