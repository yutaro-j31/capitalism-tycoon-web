...
`js/` currently holds 203 modules. Canonical CI runs across shards A-K
(`tests/run-all-shards.json` assigns B-K explicitly; unassigned tests fall into shard A) — see
